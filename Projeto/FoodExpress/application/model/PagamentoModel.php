	...
	*/
	class PagamentoModel extends Model{
		...
		public function add($numeroBoleto, $descricao, $valor, $dataVencimento, $dataEmissao, $fkGerente){
			...
			$this->insert("INSERT INTO `$this->table`(numeroBoleto, descricao, valor, dataVencimento, dataEmissao, status, fkGerente) VALUES ('$numeroBoleto', '$descricao', '$valor', '$dataVencimento', '$dataEmissao', 0, '$fkGerente')");
